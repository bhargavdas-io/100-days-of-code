...
try:
    phone_login = driver.find_element(By.XPATH, '/html/body/div[2]/div/div[1]/div/div[1]/div/div/div[2]/div[2]/span/div[3]/button')
    sleep(2)
    phone_login.click()
    sleep(1)
    ...
    more_options = driver.find_element(By.XPATH,value="/html/body/div[2]/div/div[1]/div/div[1]/div/div/div[2]/div[2]/span/button")
    more_options.click()
    phone_num = driver.find_element(By.XPATH, value="/html/body/div[2]/div/div/div/div[1]/div/div/div[2]/div[2]/span/div[3]/button")
    phone_num.click()
